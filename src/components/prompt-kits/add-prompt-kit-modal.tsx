...
export function AddPromptKitModal({ isOpen, onClose, onSuccess, categories, tools }: AddPromptKitModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent, isDraft: boolean = false) => {
    ...
    try {
      ...
      if (selectedImageFile) {
        console.log('🚀 Prompt Kit: Uploading image on save...');
        ...
        console.log('✅ Prompt Kit: Image uploaded successfully:', imageUrl);
      }
      ...
      const newPromptKit = {
        ...
        // Add required metrics fields with default values
        rating: 0,
        likes_count: 0,
        views_count: 0,
        uses_count: 0
      ...
      // Call the real API to create the prompt kit
      const createdKit = await createPromptKit(newPromptKit);
      
      onSuccess(createdKit);
      onClose();
    } catch (error) {
      ...
      <DialogContent>
        <DialogHeader>
          <div className="flex items-center justify-between w-full">
            <div>
              <DialogTitle>Add New Prompt Kit</DialogTitle>
              <DialogDescription>
                Create a comprehensive prompt kit with articles, prompts, and resources.
              </DialogDescription>
            </div>
